...
extern int op_exec_sldhu(CpuManagerType *cpu);
...
extern int op_exec_divh_11(CpuManagerType *cpu);
extern int op_exec_divh_1(CpuManagerType *cpu);
...
extern int op_exec_not1_8(CpuManagerType *cpu);
...
extern int op_exec_not1_9(CpuManagerType *cpu);
