...
#line 2 "./gen/tecsgen.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_1 = (signed_t)(3);
#line 2 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_stksz_1 = (unsigned_t)(4096);

#line 3 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_static_api_2 = 2;
#define SEMID_tSemaphore_SerialPort1_ReceiveSemaphore	(<>)
#line 3 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_sematr_2 = (unsigned_t)(TA_NULL);
#line 3 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_isemcnt_2 = (unsigned_t)(0);
#line 3 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_maxsem_2 = (unsigned_t)(1);

#line 4 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_static_api_3 = 3;
#define SEMID_tSemaphore_SerialPort1_SendSemaphore	(<>)
#line 4 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_sematr_3 = (unsigned_t)(TA_NULL);
#line 4 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_isemcnt_3 = (unsigned_t)(1);
#line 4 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_maxsem_3 = (unsigned_t)(1);

#line 5 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_static_api_4 = 4;
#line 5 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_4 = (unsigned_t)(INTNO_SCIF2_RXI);
#line 5 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_intatr_4 = (unsigned_t)(TA_NULL);
#line 5 "./gen/tecsgen.cfg"
const signed_t TOPPERS_cfg_valueof_intpri_4 = (signed_t)(-4);

#line 6 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_static_api_5 = 5;
#line 6 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_5 = (unsigned_t)(INTNO_SCIF2_TXI);
#line 6 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_intatr_5 = (unsigned_t)(TA_NULL);
#line 6 "./gen/tecsgen.cfg"
const signed_t TOPPERS_cfg_valueof_intpri_5 = (signed_t)(-4);
...
#line 8 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_6 = (unsigned_t)(INTNO_SCIF2_RXI);
#line 8 "./gen/tecsgen.cfg"
...
#line 9 "./gen/tecsgen.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_7 = (unsigned_t)(INTNO_SCIF2_TXI);
#line 9 "./gen/tecsgen.cfg"
const signed_t TOPPERS_cfg_valueof_isrpri_7 = (signed_t)(1);
...
#define TASK1	(<>)
#line 9 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_10 = (unsigned_t)(TA_NULL);
#line 9 "../sample/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_10 = (signed_t)(MID_PRIORITY);
#line 9 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_stksz_10 = (unsigned_t)(STACK_SIZE);

#line 10 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_11 = 11;
#define TASK2	(<>)
#line 10 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_11 = (unsigned_t)(TA_NULL);
#line 10 "../sample/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_11 = (signed_t)(MID_PRIORITY);
#line 10 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_stksz_11 = (unsigned_t)(STACK_SIZE);

#line 11 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_12 = 12;
#define TASK3	(<>)
#line 11 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_12 = (unsigned_t)(TA_NULL);
#line 11 "../sample/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_12 = (signed_t)(MID_PRIORITY);
#line 11 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_stksz_12 = (unsigned_t)(STACK_SIZE);
...
#line 12 "../sample/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_13 = (signed_t)(MAIN_PRIORITY);
#line 12 "../sample/sample1.cfg"
...
#define EXC_TASK	(<>)
#line 13 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_tskatr_14 = (unsigned_t)(TA_NULL);
#line 13 "../sample/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_itskpri_14 = (signed_t)(EXC_PRIORITY);
#line 13 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_stksz_14 = (unsigned_t)(STACK_SIZE);

#line 14 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_15 = 15;
#define CYCHDR1	(<>)
#line 14 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_cycatr_15 = (unsigned_t)(TA_NULL);
#line 14 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_nfymode_15 = (unsigned_t)(TNFY_HANDLER);
#line 14 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_cyctim_15 = (unsigned_t)(2000000);
#line 14 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_cycphs_15 = (unsigned_t)(0);

#line 15 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_16 = 16;
#define ALMHDR1	(<>)
#line 15 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_almatr_16 = (unsigned_t)(TA_NULL);
#line 15 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_nfymode_16 = (unsigned_t)(TNFY_HANDLER);
...
#line 17 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_17 = (unsigned_t)(INTNO1);
#line 17 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_intatr_17 = (unsigned_t)(INTNO1_INTATR);
#line 17 "../sample/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_intpri_17 = (signed_t)(INTNO1_INTPRI);

#line 18 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_static_api_18 = 18;
#define INTNO1_ISR	(<>)
#line 18 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_isratr_18 = (unsigned_t)(TA_NULL);
#line 18 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_intno_18 = (unsigned_t)(INTNO1);
#line 18 "../sample/sample1.cfg"
const signed_t TOPPERS_cfg_valueof_isrpri_18 = (signed_t)(1);
...
#line 21 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_excno_19 = (unsigned_t)(CPUEXC1);
#line 21 "../sample/sample1.cfg"
const unsigned_t TOPPERS_cfg_valueof_excatr_19 = (unsigned_t)(TA_NULL);
