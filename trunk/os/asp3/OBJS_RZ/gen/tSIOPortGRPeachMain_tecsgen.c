...
#include "tSIOPortGRPeachMain_factory.h"
...
/* cell INIB #_INIB_# */
tSIOPortGRPeachMain_INIB tSIOPortGRPeachMain_INIB_tab[] = {
    /* cell: tSIOPortGRPeachMain_CB_tab[0]:  SIOPortTarget1_SIOPortMain id=1 */
    {
        /* entry port #_EP_# */ 
    },
};
...
void
tSIOPortGRPeachMain_CB_initialize()
{
    tSIOPortGRPeachMain_CB	*p_cb;
    int		i;
    FOREACH_CELL(i,p_cb)
